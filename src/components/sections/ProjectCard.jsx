export default function ProjectCard({ project }) {
  return (
    <a
      ...
      className="group block overflow-hidden rounded-xl2 border border-line bg-white shadow-soft transition-all duration-300 ease-premium hover:-translate-y-1 hover:shadow-card-hover"
    >
      {project.image && (
