...
export default function Philosophy() {
  return (
    <section className="relative overflow-hidden bg-navy-900 py-24 sm:py-28">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-24 top-1/2 h-[420px] w-[420px] -translate-y-1/2 rounded-full bg-blue-500/10 blur-[110px]"
      />
      <Container className="relative text-center">
        <Reveal>
          <DiamondMark className="mx-auto h-8 w-8" color="#2E5BFF" />
        </Reveal>
        <Reveal delay={100}>
